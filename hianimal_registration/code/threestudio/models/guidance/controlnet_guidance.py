...
class ControlNetGuidance(BaseObject):
    ...
    class Config(BaseObject.Config):
        ...
        control_type: str = "openpose"  # normal/canny
    ...
    def configure(self) -> None:
        ...
        #     controlnet_name_or_path = "thibaud/controlnet-sd21-openpose-diffusers"
    ...
    def compute_grad_sds(
        ...
        if self.cfg.grad_norm:
            grad = torch.nn.functional.normalize(noise_pred - noise, p=2, dim=(1, 2, 3))
